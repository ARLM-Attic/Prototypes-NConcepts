...
//
// File content copyright Ray Hayes, 2003
// http://www.codeproject.com/csharp/commandlineparser.asp#xx463002xx
//
...
//				RegexOptions.ExplicitCapture);
			Regex r = new Regex(@"^((""(?<commandLine>.+?)"")|(?<commandLine>\S+))(?<remainder>.+)",
				RegexOptions.ExplicitCapture);
